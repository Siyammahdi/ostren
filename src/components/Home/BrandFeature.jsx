...
const hotspots = [
  { id: 1, top: '50%', left: '8%', title: 'ICE TEA PEACH', price: '€8,99' },
  { id: 2, top: '50%', left: '35%', title: 'ICE TEA RASPBERRY', price: '€8,99' },
  { id: 3, top: '50%', left: '65%', title: 'ICE TEA LEMON', price: '€8,99' },
  { id: 4, top: '50%', left: '82%', title: 'ICE TEA BLUEBERRY', price: '€9,90' },
]
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-[1100px] px-4 text-center">
        <h3 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-neutral-900">
          The brand that inspired us to drink
          <br />
          more water everyday.
        </h3>
        <div className="mt-4 text-xs tracking-[0.3em] text-neutral-500">VOGUE</div>
      </div>
